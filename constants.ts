...
// Data parsed from the provided OCR text.
// A unique ID is added to handle potential duplicate codes in the source document.
export const INITIAL_SURGICAL_CODES: SurgicalCode[] = [
